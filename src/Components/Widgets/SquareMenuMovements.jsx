...
function SquareMenuMovements(props) {
  return (
    <svg width="24px" height="24px" viewBox="0 0 24 24" {...props}>
      <defs>
        <style>
          {
            ".square-menu_svg__a,.square-menu_svg__c{fill:none}.square-menu_svg__a{stroke:#595959;stroke-width:1.2px}.square-menu_svg__b{stroke:none}"
          }
        </style>
      </defs>
...
export default SquareMenuMovements;
